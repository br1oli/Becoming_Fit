            ...
            <Accordion >
                <Accordion.Item eventKey="0">
                    <Accordion.Header>1. Security and protection of your personal data</Accordion.Header>
                        <Accordion.Body>
                            The security of personal data is a priority for Becoming-Fit. 
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header>2. Your privacy</Accordion.Header>
                        <Accordion.Body>
                            Becoming-Fit respects your privacy. All information you provide to us will be treated with the utmost care and security, 
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header>3. Who has access to the information?</Accordion.Header>
                        <Accordion.Body>
                            Becoming-Fit is always committed to presenting new solutions that improve the value of its products and services. 
                ...
                <Accordion.Item eventKey="4">
                    <Accordion.Header>5. Digital services</Accordion.Header>
                        <Accordion.Body>
                            Becoming-Fit is a technology company that offers computer hardware products and services related mainly to electronic commerce and digital payments.
                ...
                <Accordion.Item eventKey="8">
                    <Accordion.Header>9. Sanctions</Accordion.Header>
                        <Accordion.Body>
                            ...
                            without prejudice to other sanctions established in the particular rules of use of the services of Becoming-Fit.
                        </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="9">
                    <Accordion.Header>10. Responsability</Accordion.Header>
                        <Accordion.Body>
                            Becoming-Fit will be responsible for any defect in the provision of its service, 
