            ...
            <Accordion >
                <Accordion.Item eventKey="0">
                    <Accordion.Header>1. Privacy Policy</Accordion.Header>
                        <Accordion.Body>
                            This Privacy Policy establishes the terms in which Becoming-Fit uses and protects the information that is provided by its users when using its website.
                ...
                <Accordion.Item eventKey="3">
                    <Accordion.Header>4. Control of your personal information</Accordion.Header>
                        <Accordion.Body>
                            ...
                            Becoming-Fit reserves the right to change the terms of this Privacy Policy at any time.
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
        </div>
