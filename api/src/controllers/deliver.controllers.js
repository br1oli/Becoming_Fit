...
const postMailDeliver = async (req = request, res = response) => {
    try {
        const { name, color, size, email, message, image } = req.body;

       const output = `
            <div>
            <h3>Delivery Confirmation Email</h3>

            <h4>We have deliver your purchase to your place!</4><br/>
       ...
       let transporter = nodemailer.createTransport({
        ...
        let mailOptions = {
            ...
            text: "Deliver Confirmation Email", // plain text body
